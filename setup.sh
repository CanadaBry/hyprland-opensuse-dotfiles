...
sudo flatpak install com.spotify.Client # Spotify
sudo flatpak install dev.vencord.Vesktop # 3rd party Discord client with screenshare+audio
sudo flatpak install io.gitlab.librewolf-community # Privacy focused Firefox browser
...
# Enable services
sudo systemctl enable greetd # Login Manager
systemctl enable --user pipewire pipewire-pulse wireplumber # Audio services
